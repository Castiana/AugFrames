...
function AugFramesDBLibrary:GetSplitConfiguration()
    local tmpDB = AugFramesDBLibrary:GetDB() -- Get the DB
    return tmpDB.profile.splitConfiguration
end
-- Reset the DB
...
function AugFramesDBLibrary:GetAugFramesDBDefaults()
	return {
        profile = {
            ...
            splitConfiguration = true, -- If true, the addon will allow Party and Raid to have different targets
            areaData = { -- This holds the configuration for the 4 clickable areas
                [1] = { type = "spell", spell = "409311", name = "Prescience", unit = "player", unitParty = "player", unitRaid = "player", icon = 5199639, location = "TOPLEFT"}, -- Top Left
                [2] = { type = "spell", spell = "409311", name = "Prescience", unit = "player", unitParty = "player", unitRaid = "player", icon = 5199639, location = "TOPRIGHT"}, -- Top Right
                [3] = { type = "spell", spell = "360827", name = "Blistering Scales", unit = "player", unitParty = "player", unitRaid = "player", icon = 5199621, location = "BOTTOMLEFT"}, -- Bottom Left
                [4] = { type = "spell", spell = "406732", name = "Spatial Paradox", unit = "player", unitParty = "player", unitRaid = "player", icon = 5199645, location = "BOTTOMRIGHT"}, -- Bottom Right
            },
        },
	}
end
